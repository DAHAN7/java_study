...
public class InetAddressUrlExample {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * 
			 * URI의 하위 개념 URL(Uniform Resource Locator) - 네트워크 상에서 통합 자원(리소스)의 위치를 나타내기 위한
			 * 규칙(규약)
			 * 
			 * URN(Uniform Resource Named) - 네트워크 상에서 통합 자원의 위치를 이름으로 구분하기 위한 규칙(규약) - URL이
			 * 많이 사용되어 현재는 잘 사용되지 않는 규약
			 * 
			 */
